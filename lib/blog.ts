...
export const BLOG_POSTS: BlogPost[] = [
  ...
  },
  {
    ...
    body: [
      ...
      { type: "h2", text: "\"We already have pest control — why do we still have rats?\"" },
      {
        type: "p",
  ...
  },
  {
    ...
    body: [
      ...
      {
        type: "p",
        text: "A crack in the foundation, an open vent, a loose attic hatch — that's all the invitation a mouse needs. Once inside, they pick harborage by three rules: dark, undisturbed, close to food or nesting material.",
      },
      ...
      {
        type: "p",
        text: "If you're only checking under the sink, you're missing 90% of the problem. The evidence that matters — rub marks on rafters, droppings behind insulation, gnawing at the attic hatch — sits in places a flashlight-and-a-glance check never reaches. That's why our inspections run top to bottom: attic, walls, crawl space, garage, exterior.",
      },
      {
        type: "p",
