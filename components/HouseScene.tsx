...
export function HouseScene() {
  return (
    <div className="bg-ink-900 rounded-md px-[34px] pt-[38px] pb-[30px]">
      <svg
        viewBox="0 0 440 300"
        role="img"
      ...
      >
        {/* ground */}
        <path d="M0 252 H440" stroke="#ECECEC" strokeOpacity=".35" strokeWidth="2" />
        {/* desert sun */}
        <circle cx="376" cy="58" r="26" fill="#E4342B" opacity=".85" />
        {/* mesa horizon */}
        <path
        ...
        {/* blocked arrows */}
        <g stroke="#E4342B" strokeWidth="2.5" strokeLinecap="round" fill="none">
          <path d="M80 236 H108" />
